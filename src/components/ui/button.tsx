  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        interested: "border-2 border-amber-800 bg-gradient-to-br from-amber-700 to-amber-800 text-white hover:from-amber-600 hover:to-amber-700 hover:-translate-y-0.5",
        going: "border-2 border-amber-800 bg-gradient-to-br from-amber-700 to-amber-800 text-white hover:from-amber-600 hover:to-amber-700 hover:-translate-y-0.5",
        "interested-active": "border-2 border-amber-900 bg-gradient-to-br from-amber-800 to-amber-900 text-white shadow-md",
        "going-active": "border-2 border-amber-900 bg-gradient-to-br from-amber-800 to-amber-900 text-white shadow-md",
      },
      size: {
